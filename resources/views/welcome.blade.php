...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-50">
        <nav class="bg-white border-b-2 border-orange-400 dark:bg-gray-900 px-80 ">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('image/logo.png') }}" class="" alt="Flowbite Logo" />
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="#" class="block py-2 px-3 text-white active:font-bold bg-orange-700 rounded md:bg-transparent md:text-orange-700 md:p-0 dark:text-white md:dark:text-orange-500" aria-current="page">Beranda</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0 dark:text-white md:dark:hover:text-orange-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Berita</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0 dark:text-white md:dark:hover:text-orange-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Kontak</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0 dark:text-white md:dark:hover:text-orange-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Tentang Kami</a>
                    </li>
                </ul>
            </div>
            </div>
        </nav>
        <header class="pt-28 px-80 ">
            <img src="{{ asset('image/bag.png') }}" class="w-fit bg-cover mx-auto rounded-lg" alt="">
            <div class="grid grid-cols-2 gap-5 mt-10 content-center items-start">
        ...
        <section class="py-48 px-80">
            ...
            <div class="grid grid-cols-3 gap-4 content-center pt-16">
        ...
        {{-- END SECTION DONASI --}}
        {{-- START SECTION PILAR  --}}
        <section class="w-full py-8 bg-gray-100 h-fit mastering-tools ">
            <div class="p-4 space-y-4 text-center">
                <h2 class="text-4xl font-bold">6 Pilar Program Laziz<span class="text-orange-400">mu</span>.</h2>
                <p class="text-xl text-gray-400">Mari kita dukung program-program yang dilaksanakan oleh <b class="text-black">Lazizmu</b> .</p>
            </div>
            <div class="mastering-tools">
                <div class="tools-slideshow">
                    <div class="card-animation-right grid grid-cols-3 gap-10 content-center pt-16 px-5">
                    ...
                    <div class="card-animation-left grid grid-cols-3 gap-10 content-center pt-16 px-5">
                ...
                <div>
                    <figure class="relative max-w-fit transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                        ...
                        <figcaption class="absolute px-4 text-gray-100 dark:text-white bottom-0 bg-orange-950 h-fit p-4 w-full rounded-lg">
                            <p class="z-50 font-semibold">Lorem ipsum dolor sit amet consectetur adipisicing elit...</p>
                            <hr>
        ...
        <footer class="bg-orange-50 dark:bg-gray-900">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="md:flex md:justify-between gap-4">
                            ...
                            <ul class="space-y-4 text-gray-500 list-disc list-inside dark:text-gray-400">
                                <li class="space-x-3">
                                    ...
                                    <div class="inline-flex items-start">
                                        <div>
                                            <svg class="w-4 h-4 text-orange-800 dark:text-white me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z"/>
                                            </svg>
                                        </div>
                                        <div>
                                            <span class="text-content">Jl. Menteng Raya No.62, RT.3/RW.9, Kb. Sirih, Kec. Menteng, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10340</span>
                                        </div>
                                    </div>
                                    <div class="inline-flex items-start">
                                        <div>
                                        ...
                                        <div class="text-content">
                                            <span>Telp. 021 3150400 HP: 0856-1626-222</span>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <span class="font-bold ">Kantor Bondowoso</span>
                                    <hr class="py-1">
                                    <div class="inline-flex items-start">
                                        <svg class="w-6 h-6 text-orange-800 dark:text-white me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z"/>
                                        </svg>
                                        <span class="text-content">Jl. Menteng Raya No.62, RT.3/RW.9, Kb. Sirih, Kec. Menteng, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10340</span>
                        ...
                        <div class="w-1/2">
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Selengkapnya</h2>
                            <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                                <li>
                                   <a href="" class="text-sm underline hover:text-orange-400">Berita</a>
                                </li>
                                <li>
                                    <a href="" class="text-sm underline hover:text-orange-400">Kontak</a>
                                </li>
                                <li>
                                    <a href="" class="text-sm underline hover:text-orange-400">Tentang Kami</a>
                                </li>
                            </ul>
                        </div>
