...
@section('content')
    <section class="max-w-7xl max-h-fit py-20 mx-auto">
        <div class="p-4 space-y-4 text-center mb-5">
            <h2 class="text-4xl font-bold">Program Donasi</h2>
            <p class="text-xl text-gray-400">Program Donasi terbaru <b class="text-black">Lazizmu</b> .</p>
        </div>
        <form class="max-w-6xl mx-auto" method="GET" action="{{ route('frontend.donasi.index') }}">
